...
class DataLoader(object):
    ...
    def preprocess(self, data, vocab, opt):
        ...
        for d in data:
            ...
            tokens[ss : se + 1] = ["SUBJ-" + d["subj_type"]] * (
                se - ss + 1
            )  # maybe should be modified to stanford_ner
            tokens[os : oe + 1] = ["OBJ-" + d["obj_type"]] * (
                oe - os + 1
            )  # maybe should be modified to stanford_ner
            ...
            processed += [
                (tokens, pos, ner, deprel, subj_positions, obj_positions, relation)
            ]
        return processed
